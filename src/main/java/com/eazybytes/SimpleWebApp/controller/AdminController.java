...
import com.eazybytes.SimpleWebApp.repository.CoursesRepository;
...
public class AdminController {
   ...
   /* @GetMapping("/deleteStudent")
    public ModelAndView deleteStudent(Model model, @RequestParam int personId, HttpSession session){
        ...
        ModelAndView modelAndView = new ModelAndView("redirect:/admin/displayStudent?classId=" + eazyClass.getClassId());
        return modelAndView;
    ...
    public ModelAndView displayCourses(Model model){
       // List<Courses> coursesList = coursesRepository.findByOrderByName();
        String fieldName = "name";
        List<Courses> coursesList = coursesRepository.findAll(Sort.by(fieldName).descending());
    ...
    public ModelAndView addStudentToCourse(Model model,@ModelAttribute("person") Person person,
                                           HttpSession session, @RequestParam(required = false) Error error){
        ModelAndView modelAndView = new ModelAndView();
